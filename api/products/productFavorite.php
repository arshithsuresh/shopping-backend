<?php
    ...
    if(!isset($_POST['userid']) || !isset($_POST['productid']) || !isset($_POST['message']))
    {
    ...
    $result = $favoriteHandle->addToInterestedList($userId,$productId,$message);   

    if($result == true)
    {
        http_response_code(200);
        echo json_encode(array('message'=>"Product added to interested list."));
        die();
    }
